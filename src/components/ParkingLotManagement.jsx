  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex justify-center">
        <img src={ParkingLotImage} alt="Parking Lot Management" className="rounded-lg shadow-lg md:h-96 h-48" />
      </div>
      <div className="mt-8">
        <h2 className="text-2xl font-bold">ROYA VALET PARKING SERVICES LLC Is Not Just About Best Valet Services</h2>
        <p className="text-lg text-gray-700 mt-4">
          ROYA VALET PARKING SERVICES LLC is one of the best valet parking in UAE. We provide total valet parking and transportation solutions. Our management staff has vast experience in the valet industry. As a team, our staff can accommodate and customize all of your individualized parking and transportation needs.
        </p>
        <p className="text-lg text-gray-700 mt-4">
          Lot Management for paid self-parking lots - With the limited amount of parking in growing cities we understand the need to maximize the parking and maximize revenue. ROYA VALET PARKING SERVICES LLC can assist with providing a revenue sharing plan and management of the parking lot to ensure maximum revenue potential for our clients.
        </p>
        <p className="text-lg text-gray-700 mt-4">
